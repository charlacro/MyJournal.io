...
const ThoughtsForm = ({date,inputThoughts,handleDate,handleInputThoughts,handleSave}) => {
  ...
  return (
    <div className='mb-3 row d-flex justify-content-center'>
      ...
      <BTForm className='form p-3 bg-dark color-white rounded-3 was-validated' style={{width: "500px", color: "white", fontWeight: "bold"}} onSubmit={handleSave}>
        ...
        <Button style={{width: "100%", color: "white", fontWeight: "bold"}} className='border-white' type='save'color='secondary'>Save</Button>
      </BTForm>
    </div>
  )
}
